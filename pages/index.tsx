    ...
    return (
        <Layout>
            ...
            <div>
                ...
                <p className="mt-4 p-2 border-2 border-title font-semibold bg-black">
            ...
            <h4 className="text-xl mt-4 font-bold border p-2">第一步：創建專案</h4>
            <p className="my-4">
                首先，到Firebase官網，點選右上角的「Sign in」，登入你的Google帳號。
                <a href="https://firebase.google.com/" target="_blank" rel="noopener" className="mt-4">
                    Firebase連結
                </a>
            </p>
            ...
            <p className="mt-4">登入完成後，點選一樣在右上角的Go to console，進入Firebase的控制台。</p>
            ...
            <h4 className="text-xl mt-4 font-bold border p-2">第二步：新增應用程式</h4>
            ...
            <p className="my-4">通常，我都會創建一個lib資料夾，並在下面建立一個init-firebase.tsx的檔案，然後將Firebase的初始化程式碼放在裡面。</p>
            <a href="https://firebase.google.com/docs/web/setup?authuser=0" target="_blank" rel="noopener" className="mt-4">
                參考連結 (資料夾結構)
            </a>
